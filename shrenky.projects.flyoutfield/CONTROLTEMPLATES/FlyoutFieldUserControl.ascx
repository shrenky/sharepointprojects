...
<SharePoint:RenderingTemplate ID="FlyoutFieldRenderingTemplate" runat="server">  
    <script src="/_layouts/15/shrenky.projects.flyoutfield/jquery-1.11.1.min.js" runat="server" type="text/javascript"></script>
    <script src="/_layouts/15/shrenky.projects.flyoutfield/jquery.SPServices-2014.01.min.js" runat="server" type="text/javascript"></script>
    <Template>  
